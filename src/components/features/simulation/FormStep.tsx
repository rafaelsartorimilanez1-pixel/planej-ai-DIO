...
export function FormStep({icon: Icon, title, question, inputProps, submitButtonProps, onBack, onNext, hideBackButton} : FormStepsProps & ActionButtonsProps) {
    ...
    return(
        <div className="bg-card rounded-2xl p-6 shadow-[4px_4px_18px_opx_rgba(0,0,0,0,.2)] sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:gap-6">
                    ...
                    type="submit"
                    variant="primary"
                    className="order-1 flex-1 sm:orger-2"
                    disabled={!inputValue}
                    >
